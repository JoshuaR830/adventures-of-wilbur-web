  ...
  return (
    <Layout>
      ...
      <div className={styles.flexContainer}>
        {postData.map(({id, title, body, wilburImage}) => (
          <Card id={id} title={title} body={body} wilburImage={`https://adventures-of-wilbur-images.s3.eu-west-2.amazonaws.com/${wilburImage}`}/>
        ))}
